...
- Adapted from a the DeepLearning.AI "Building Agentic RAG with Llamaindex" course originally built around OpenAI models, modified here to run entirely on the Gemini API.
